...
```{r ubicacion, include=TRUE, cache=FALSE, echo=FALSE , fig.align='center', fig.cap='Estructura organizacional',fig.id='estruc', fig.pos='H', out.width='50%'}
knitr::include_graphics("marco teorico/image/ubicacion.png")
```
