...
\end{tcolorbox}
    ...
    \hypertarget{propuesta-de-mejora-de-proceso-de-gestiuxf3n-de-inventario-mediante-la-implementaciuxf3n-de-wms-para-el-caso-de-uxe1rea-de-almacuxe9n-del-taller-de-servicio-mecuxe1nico-integral-y-electricidad-automotriz-duarcon}{%
\section{Propuesta de mejora de proceso de gestión de inventario,
mediante la implementación de WMS para el caso de área de almacén del
taller de servicio mecánico integral y electricidad automotriz
DUARCON}\label{propuesta-de-mejora-de-proceso-de-gestiuxf3n-de-inventario-mediante-la-implementaciuxf3n-de-wms-para-el-caso-de-uxe1rea-de-almacuxe9n-del-taller-de-servicio-mecuxe1nico-integral-y-electricidad-automotriz-duarcon}}

\hypertarget{trabajo-de-titulaciuxf3n-presentado-en-conformidad-a-los-requisitos-para-obtener-el-titulo-de-ingueniero-civil-industrial-tesis-para-titulo-para-la-obtenciuxf3n-del-titulo-ingeniero-civil-industrial}{%
\section{Trabajo de titulación presentado en conformidad a los
requisitos para obtener el Titulo de Ingueniero Civil Industrial TESIS
PARA TITULO PARA LA OBTENCIÓN DEL TITULO INGENIERO CIVIL
INDUSTRIAL"}\label{trabajo-de-titulaciuxf3n-presentado-en-conformidad-a-los-requisitos-para-obtener-el-titulo-de-ingueniero-civil-industrial-tesis-para-titulo-para-la-obtenciuxf3n-del-titulo-ingeniero-civil-industrial}}

\hypertarget{felipe-kiefer-guenupan}{%
\section{Felipe Kiefer Guenupan}\label{felipe-kiefer-guenupan}}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{err}{`}\PY{err}{`}\PY{err}{`}\PY{p}{\PYZob{}}\PY{n}{r} \PY{n}{vauto}\PY{p}{,} \PY{n}{echo}\PY{o}{=}\PY{n}{FALSE}\PY{p}{,} \PY{n}{fig}\PY{o}{.}\PY{n}{cap}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Ventas mensuales a publico del mercado de livianos y medianos}\PY{l+s+s1}{\PYZsq{}}\PY{p}{\PYZcb{}}
 \PY{n}{anac}
...
políticas y económicas a nivel local''{[}\^{}22{]}, posterior debido al
desconfinamiento progresivo a nivel nacional de ciertas comunas por la
implementación del programa Paso a Paso, Adicionalmente, el factor del
retiro del 10\% de las AFP ha demostrado un nivel de incidencia certero
en la adquisición de bienes durables como los automóviles, lo que se
sumaría a la recuperación del sector {[}\^{}23{]}. Meses posteriores
este mercado automotriz a visto una disminucion en la variacion de
ventas conrespecto al año movil. En consecuencia se espera un aumento en
la demanda de los servicios de mantenimiento y reparación automotriz.
